...
In addition, [this document]({{ site.url }}{{ site.baseurl }}/doc/integration.html#lda-mode) delves into the Rspamd LDA proxy mode, a versatile tool that can be employed by virtually any MTA.
